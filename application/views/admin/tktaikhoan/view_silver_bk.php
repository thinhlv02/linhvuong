<div class="page-title">
    <div class="title_left"><h3>Thống kê tài nguyên bạc , lúa</h3></div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form id="formAddProduct_silver" data-parsley-validate class="form-horizontal form-label-left" method="post"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <label class="control-label col-md-1 col-sm-1 col-xs-12 text-left" for="first-name">Tài nguyên<span
                                class="required">*</span></label>
                    <div class="col-md-1 col-sm-1 col-xs-12">
                        <select class="select2_group form-control"  name="resources">
