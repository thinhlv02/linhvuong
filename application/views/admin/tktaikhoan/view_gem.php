<div class="page-title">
    <div class="title_left"><h3>Thống kê ngọc</h3></div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <form id="formAddProduct_gem" data-parsley-validate class="form-horizontal form-label-left" method="post"
